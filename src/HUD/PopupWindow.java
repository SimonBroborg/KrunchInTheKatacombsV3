...
public class PopupWindow {
    ...
    public void draw(Graphics2D g2d){
        ...
        width = fm.stringWidth(text) + HORIZONTAL_OFFSET * 2;
        x = GameComponent.SCALED_WIDTH /2 - (int)width / 2;
        maxHeight = font.getSize() + VERTICAL_OFFSET * 2;
        ...
        if(height == maxHeight) {
            ...
            g2d.drawString(continueText, x + width - HORIZONTAL_OFFSET - fm.stringWidth(continueText), y + height - 14);
        }
    }
}
