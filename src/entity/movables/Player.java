...
public class Player extends Damageable
{
	...
	try {
		...
		final int[] numFrames = { 2, 8, 1, 2, 4, 2, 5 };
    ...
    /**
     * Get the players flashlight
     *
     * @return A flashlight
     */
    public FlashLight getFl() {
	return fl;
    }
    ...
    // the players own input handlers
	...
	if (k == KeyEvent.VK_W) setClimbingUp(false);
	if (k == KeyEvent.VK_S) setClimbDown(false);
